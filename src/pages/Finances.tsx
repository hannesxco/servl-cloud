...
import { Euro, TrendingUp, Wallet, ArrowDown, ArrowUp } from 'lucide-react';
import { getFinances } from '@/lib/store';
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, CartesianGrid } from 'recharts';

export default function Finances() {
  const [finances] = useState(getFinances());
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-6">
          <h2 className="font-semibold text-foreground mb-4 flex items-center gap-2"><ArrowUp size={16} className="text-success" />Fixe monatl. Einnahmen</h2>
          <div className="space-y-3">
            {finances.fixedMonthlyIncome.map((i, idx) => (
              <div key={idx} className="flex items-center justify-between p-3 rounded-md bg-secondary">
